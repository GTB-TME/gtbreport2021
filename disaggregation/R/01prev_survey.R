...
#'
#' Can very likely solve this by iteration. Having obtained $MF_0$ and $\rho_a$, the age/sex disaggregation of (adult) prevalence is:
#'
#'
#' $$P_{a,s}=\frac{(MF_0)^(s==m)\rho_a N_{a,s}}{\sum_{b,t}(MF_0)^(t==m)\rho_b N_{b,t}}$$
#' 
#'
...
#'
prevsplits <- prevsplitsL <- prevsrc <- list() #jj
...
## TODO edit to exclude larger data & many plots from repo
