...
## update here
estyr <- 2020                              # update
load(here('disaggregation/R/02children/data/2017/eprev.Rdata')) #TB prevalence old
load(here('disaggregation/R/02children/data/2017/est.Rdata'))#TB est old
estold <- copy(est)
...
if(!file.exists(BCGfn)){
  BCG <- readxl::read_xls(here('disaggregation/R/02children/data',
