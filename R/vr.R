...
load(here('data/unaids.rda'))  #!!! introduced dep on 04/08/2021 (see line 310)
...
xlfn <- 'input/VR/info_TB_may21.xls'
...
# update RUS
vr2[iso3=='RUS' & year==yr, ghe.env := total]
vr2[iso3=='RUS' & year==yr, env := total]
