...
Following large increases in the global number of TB case notifications per year between 2017 and 2019, the reported data show a substantial fall of `r ftb(100*(1-last(global$c.newinc)/global$c.newinc[20]))`% between 2019 and 2020, from `r ftb(global$c.newinc[20]/1e6)` million to `r ftb(global$c.newinc[21]/1e6)` million (`r lnk("Fig. 1.1")`). This set back, coupled with continued disruptions in 2021, mean that the United Nations (UN) high-level meeting target of treating 40 million people diagnosed with TB in the 5-year period 2018–2022 is off-track.  

A similar pattern of increases in notifications up to 2019 followed by a sharp fall in 2020 is also evident in five of the six WHO regions (`r lnk("Fig. 1.2")`), with particularly large absolute and relative reductions in the regions of South-East Asia and the Western Pacific. In combination, these two regions accounted for `r ftb(100 * (regional[g.whoregion %in% c('SEA','WPR') & year==2019, sum(c.newinc)] - regional[g.whoregion %in% c('SEA','WPR') & year==2020, sum(c.newinc)])/(global[year==2019, c.newinc]-global[year==2020, c.newinc]))`% of the global reduction in TB case notifications between 2019 and 2020. The decline in the WHO African Region was much more modest (`r ftb(100 * (1 - regional[g.whoregion %in% c('AFR') & year==2020, sum(c.newinc)] / regional[g.whoregion %in% c('AFR') & year==2019, sum(c.newinc)]))`%). In the WHO European Region, there was a clear discontinuity in an existing downward trend in notifications (reflecting an underlying decline in TB incidence), suggesting that detection and reporting of TB cases in this region was also affected by the COVID-19 pandemic.

Monthly and quarterly TB notifications in 2020 and the first half of 2021 were substantially below the average for 2019 in most of the high TB burden countries (`r lnk("Fig. 1.3")`, `r lnk("Fig. 1.4")`), with the largest relative reductions in annual notifications between 2019 and 2020 seen in Gabon (`r ftb(100 * (1 - est[iso3=='GAB' & year==2020, c.newinc] / est[iso3=='GAB' & year==2019, c.newinc]))`%), the Philippines (`r ftb(100 * (1 - est[iso3=='PHL' & year==2020, c.newinc] / est[iso3=='PHL' & year==2019, c.newinc]))`%), Lesotho (`r ftb(100 * (1 - est[iso3=='LSO' & year==2020, c.newinc] / est[iso3=='LSO' & year==2019, c.newinc]))`%), Indonesia (`r ftb(100 * (1 - est[iso3=='IDN' & year==2020, c.newinc] / est[iso3=='IDN' & year==2019, c.newinc]))`%) and India (`r ftb(100 * (1 - est[iso3=='IND' & year==2020, c.newinc] / est[iso3=='IND' & year==2019, c.newinc]))`%) (`r lnk("Fig. 1.5")`).  Exceptions to this general pattern included the Democratic Republic of Congo, Nigeria, the United Republic of Tanzania and Zambia (`r lnk("Fig. 1.3")`). 
